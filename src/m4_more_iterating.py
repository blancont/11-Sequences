...
def run_test_count_items_bigger_than():
    ...
    threshold = 50
    expect = 1
    ans = count_items_bigger_than(seq, threshold)
    print()
    print('Test 9 expected:', expect)
    print('         actual:', ans)
...
def run_test_count_positive_sines():
    ...
    expect = 3
    ans = count_positive_sines([1, 2, 3])
    print()
    print('Test 11 expected:', expect)
    print('          actual:', ans)

    expect = 0
    ans = count_positive_sines([10, 11, 10])
    print()
    print('Test 12 expected:', expect)
    print('          actual:', ans)
...
def run_test_sum_first_n():
    ...
    expect = 3
    ans = sum_first_n([1, 2, 3, 4], 2)
    print()
    print('Test 8 expected:', expect)
    print('         actual:', ans)

    expect = 6
    ans = sum_first_n([1, 2, 3, 4], 3)
    print()
    print('Test 9 expected:', expect)
    print('         actual:', ans)
